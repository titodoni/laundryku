...
const features = [
  ...
  { icon: ShieldCheck, title: "Multi Peran", desc: "Owner, kasir, operator, kurir — satu sistem." },
];
          ...
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Button asChild size="lg" className="tap-target">
                <Link href="/register">Mulai Gratis 7 Hari <ArrowRight className="ml-1 h-4 w-4" /></Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="tap-target">
                <Link href="/register">Masuk ke Toko</Link>
              </Button>
            </div>
        ...
        <div className="container">
          ...
          <div className="mx-auto mt-10 grid max-w-3xl gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <Button asChild variant="outline" className="mt-6 w-full tap-target"><Link href="/register">Mulai Gratis</Link></Button>
            </div>
            <div className="rounded-2xl border-2 border-primary bg-card p-6 shadow-sm">
              ...
              <Button asChild className="mt-6 w-full tap-target"><Link href="/register">Upgrade ke Pro</Link></Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-border bg-primary py-12 text-primary-foreground">
        <div className="container flex flex-col items-center gap-4 text-center">
          ...
          <Button asChild size="lg" variant="secondary" className="tap-target">
            <Link href="/register">Daftar Sekarang <ArrowRight className="ml-1 h-4 w-4" /></Link>
          </Button>
        </div>
      </section>
    </>
