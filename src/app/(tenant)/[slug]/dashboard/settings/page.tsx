  ...
  return (
    <section className="space-y-6">
      <div className="space-y-2">
        ...
        <h1 className="font-display text-2xl font-bold tracking-tight sm:text-3xl">Profil Organisasi</h1>
        <p className="max-w-2xl text-sm text-muted-foreground">
          Kelola profil toko, logo, SLA, dan identitas yang tampil di halaman publik.
        </p>
      </div>
